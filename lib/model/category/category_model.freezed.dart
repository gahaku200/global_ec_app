...
mixin _$CategoryModel {
  ...
  String get catText => throw _privateConstructorUsedError;
...
abstract class $CategoryModelCopyWith<$Res> {
  ...
  @useResult
  $Res call({String id, String catText, String imgPath});
}
  ...
  $Res call({
    ...
    return _then(_value.copyWith(
      ...
      catText: null == catText
          ? _value.catText
          : catText // ignore: cast_nullable_to_non_nullable
              as String,
...
class _$_CategoryModel implements _CategoryModel {
  _$_CategoryModel(
      {required this.id, required this.catText, required this.imgPath});
  ...
  @override
  String toString() {
    return 'CategoryModel(id: $id, catText: $catText, imgPath: $imgPath)';
  }
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.catText, catText) || other.catText == catText) &&
            (identical(other.imgPath, imgPath) || other.imgPath == imgPath));
  }

  @JsonKey(ignore: true)
  @override
  int get hashCode => Object.hash(runtimeType, id, catText, imgPath);
...
abstract class _CategoryModel implements CategoryModel {
  factory _CategoryModel(
      ...
      required final String catText,
      required final String imgPath}) = _$_CategoryModel;
